...
<div class="content">
    ...
    <p class="add-paragraph">Fill out the form below to register a new doctor into the system. Please ensure that all the doctor's personal and medical information is accurate and complete. This data will help in managing appointments, tracking medical history, and providing quality care.</p>
    ...
    <div class="card">
        <form method="POST">
            ...
            <div class="btn-container">
                ...
                <button type="submit" name="add_doctor" class="btn btn-save">Save Doctor</button>
            </div>
        </form>
    </div>
<div class="footer">

...
if (isset($_POST['edit_user'])) {
    ...
    $stmt = $conn->prepare("UPDATE users SET username = ?, email = ? WHERE id = ? AND role_id = 3");
...
<div class="content">
    <h1>Edit User</h1>
    <p class="edit-user-paragraph">Use the form below to update the user’s information. You can modify details such as the username and email. Please make sure all changes are accurate before saving. Editing a user’s details will immediately affect their access and permissions within the system.</p>
